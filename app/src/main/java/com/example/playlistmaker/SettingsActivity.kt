...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupUI(){
        ...
        shareAppButton.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, "ИС-211")
        ...
        contactSupportButton.setOnClickListener {
            val supportEmail = "efim.styopin@bk.ru"
    ...
    private fun getLayoutForTheme(): Int {
        ...
        return if (isDarkMode) R.layout.activity_settings_dark else R.layout.activity_settings
    }
